...
(window.EXPATIA = window.EXPATIA || {}).realestate = [
  {id:'re-words',emoji:'🏙️',kind:'vocab',title:'Le vocabulaire immobilier',desc:'Off-plan, freehold, promoteur, livraison.',
    ...
    words:[
      ['Property','Bien immobilier','عقار','🏠','PRO-peu-ti'],
      ['Townhouse','Maison de ville','تاون هاوس','🏘️','TAOUN-haous'],
      ['Off-plan','Sur plan','على الخارطة','📐','OF-PLANN'],
      ['Ready property','Bien livré (prêt à habiter)','عقار جاهز','🔑','RÈ-di PRO-peu-ti'],
      ['Freehold','Pleine propriété','تملك حر','📜','FRI-hold'],
      ['Leasehold','Bail de longue durée','حق انتفاع طويل الأمد','⏳','LIS-hold'],
      ['Developer','Promoteur','المطور العقاري','🏗️','di-VÈ-leu-peu'],
      ['Handover','Remise des clés (livraison)','التسليم','🗝️','HANND-o-veu'],
      ['Service charges','Charges de copropriété','رسوم الخدمات','🧾','SEU-vis TCHÂ-djiz'],
      ['Real estate agent','Agent immobilier','وسيط عقاري','🧑‍💼','RIL is-TÉÏT ÉÏ-djeunt']
    ],
    dialogue:[
      {scene:'Au salon de l’immobilier'},
      {who:'Agent',en:'Are you interested in off-plan or ready properties?',fr:'Vous cherchez un bien sur plan ou un bien livré ?',ar:'هل تهتم بالعقارات على الخارطة أم بالعقارات الجاهزة؟',ph:'â you INN-treus-tid inn OF-PLANN ô RÈ-di PRO-peu-tiz'},
      {me:true,choices:['Ready properties. I want to rent it out quickly.','Ready properties. I want a table for two.','Ready properties. I want to top up.'],fr:'Un bien livré. Je veux le louer rapidement.',ar:'العقارات الجاهزة. أريد تأجيره بسرعة.',ph:'RÈ-di PRO-peu-tiz. aï OUONT tou RÈNT it AOUT KOUIK-li'},
      {who:'Agent',en:'Good idea. Do you prefer an apartment or a townhouse?',fr:'Bonne idée. Vous préférez un appartement ou une maison de ville ?',ar:'فكرة جيدة. هل تفضل شقة أم تاون هاوس؟',ph:'goud aï-DI-eu. dou you pri-FEUR ann eu-PÂT-meunt or eu TAOUN-haous'},
      {me:true,choices:['An apartment. Is it freehold?','An apartment. Is it on offer?','An apartment. Is it a virus?'],fr:'Un appartement. Est-ce en pleine propriété ?',ar:'شقة. هل هي تملك حر؟',ph:'ann eu-PÂT-meunt. iz it FRI-hold'},
      {who:'Agent',en:'Yes, all our properties are freehold.',fr:'Oui, tous nos biens sont en pleine propriété.',ar:'نعم، جميع عقاراتنا تملك حر.',ph:'YÈS, OL AOU-eu PRO-peu-tiz â FRI-hold'},
      ...
      {who:'Agent',en:'About fifteen dirhams per square foot per year.',fr:'Environ quinze dirhams le pied carré par an.',ar:'حوالي خمسة عشر درهمًا للقدم المربع سنويًا.',ph:'eu-BAOUT fif-TIN DIR-hamz peu SKOUÈ FOUT peu YIEU'}
    ]},
  {id:'re-analyse',emoji:'🔍',kind:'phrases',title:'Analyser un bien',desc:'Prix, loyer, rendement, historique, frais.',
    words:[
      ['What’s the asking price?','Quel est le prix demandé ?','ما هو السعر المطلوب؟','🏷️','OUOTS ði ÂS-kinng PRAÏS'],
      ['What’s the price per square foot?','Quel est le prix au pied carré ?','ما سعر القدم المربع؟','📐','OUOTS ðeu PRAÏS peu SKOUÈ FOUT'],
      ...
      ['How long has it been on the market?','Depuis combien de temps est-il sur le marché ?','منذ متى وهو معروض في السوق؟','⏳','haou LONNG haz it BIN onn ðeu MÂ-kit'],
    ...
    dialogue:[
      ...
      {who:'Agent',en:'This two-bedroom apartment is in Jumeirah Village Circle.',fr:'Cet appartement de deux chambres est à Jumeirah Village Circle.',ar:'هذه الشقة ذات غرفتي النوم تقع في قرية جميرا الدائرية.',ph:'ðis TOU-BÈD-roum eu-PÂT-meunt iz inn djou-MÉÏ-ra VI-lidj SEU-keul'},
      ...
      {who:'Agent',en:'Yes, for eighty-five thousand a year.',fr:'Oui, pour quatre-vingt-cinq mille par an.',ar:'نعم، بخمسة وثمانين ألفًا سنويًا.',ph:'YÈS, for ÉÏ-ti-FAÏV þAOU-zeund eu YIEU'},
      {me:true,choices:['So the gross yield is about seven percent?','So the flight is about seven hours?','So the rice is in aisle seven?'],fr:'Donc le rendement brut est d’environ sept pour cent ?',ar:'إذن العائد الإجمالي حوالي سبعة بالمئة؟',ph:'SO ðeu GROS YILD iz eu-BAOUT SÈ-veun peu-SÈNT'},
      {who:'Agent',en:'Exactly. And the service charges are about twelve thousand a year.',fr:'Exactement. Et les charges sont d’environ douze mille par an.',ar:'بالضبط. ورسوم الخدمات حوالي اثني عشر ألفًا سنويًا.',ph:'ig-ZAKT-li. annd ðeu SEU-vis TCHÂ-djiz ar eu-BAOUT TOUÈLV þAOU-zeund eu YIEU'},
      ...
      {who:'Agent',en:'Of course. I’ll email you the details.',fr:'Bien sûr. Je vous envoie le détail par email.',ar:'بالتأكيد. سأرسل لك التفاصيل بالبريد الإلكتروني.',ph:'ov KÔS. aïl I-méïl you ðeu DI-téïlz'}
    ]},
  {id:'re-offer',emoji:'✍️',kind:'phrases',title:'Faire une offre',desc:'Négocier le prix, l’apport, les frais, conclure.',
    ...
    words:[
      ['I’d like to make an offer.','Je voudrais faire une offre.','أريد تقديم عرض.','✍️','aïd LAÏK tou MÉÏK ann O-feu'],
      ...
      ['When is the handover?','Quand a lieu la remise des clés ?','متى موعد التسليم؟','🗝️','OUÈN iz ðeu HANND-o-veu'],
      ['Who pays the transfer fees?','Qui paie les frais de transfert ?','من يدفع رسوم نقل الملكية؟','🧾','HOU PÉÏZ ðeu TRANNS-feu FIZ'],
      ['We have a deal.','Marché conclu.','اتفقنا.','🤝','oui HAV eu DIL']
    ],
    dialogue:[
      {scene:'La négociation'},
      {who:'Agent',en:'The seller is asking one point two million.',fr:'Le vendeur demande un million deux cent mille.',ar:'البائع يطلب مليونًا ومئتي ألف.',ph:'ðeu SÈ-leur iz ÂS-kinng OUANN POÏNT TOU MIL-yeun'},
      ...
      {who:'Agent',en:'A little. What is your budget?',fr:'Un peu. Quel est votre budget ?',ar:'قليلًا. ما هي ميزانيتك؟',ph:'eu LI-teul. OUOT iz yô BA-djit'},
      ...
      {who:'Agent',en:'I’ll call the seller. … He accepts one point one five.',fr:'J’appelle le vendeur. … Il accepte un million cent cinquante mille.',ar:'سأتصل بالبائع. … يقبل بمليون ومئة وخمسين ألفًا.',ph:'aïl KOL ðeu SÈ-leu. hi ak-SÈPTS OUANN POÏNT OUANN FAÏV'},
      ...
      {who:'Agent',en:'Usually the buyer.',fr:'En général, l’acheteur.',ar:'عادةً المشتري.',ph:'YOU-jou-eu-li ðeu BAÏ-eu'},
      ...
      {who:'Agent',en:'Congratulations! I’ll prepare the contract.',fr:'Félicitations ! Je prépare le contrat.',ar:'مبروك! سأجهز العقد.',ph:'keun-gra-tchou-LÉÏ-cheunz ! aïl pri-PÈ ðeu KONN-trakt'}
    ]},
  {id:'re-mission',emoji:'🎯',kind:'mission',title:'Mission 08 — Buy an investment property',desc:'Rencontrer un agent, analyser, négocier.',
    ...
    dialogue:[
      ...
      {who:'Agent',en:'Welcome. Are you buying to live or to invest?',fr:'Bienvenue. Vous achetez pour habiter ou pour investir ?',ar:'أهلًا بك. هل تشتري للسكن أم للاستثمار؟',ph:'OUÈL-keum. â you BAÏ-inng tou LIV ô tou inn-VÈST'},
      {me:true,choices:['To invest. I’m looking for an investment property.','To invest. I’m looking for the rice.','To invest. I’m looking for my passport.'],fr:'Pour investir. Je cherche un bien d’investissement.',ar:'للاستثمار. أبحث عن عقار استثماري.',ph:'tou inn-VÈST. aïm LOU-kinng for ann inn-VÈST-meunt PRO-peu-ti'},
      {who:'Agent',en:'What is your budget?',fr:'Quel est votre budget ?',ar:'ما هي ميزانيتك؟',ph:'OUOT iz yô BA-djit'},
      ...
      {who:'Agent',en:'About seventy thousand a year. It’s rented until March.',fr:'Environ soixante-dix mille par an. Il est loué jusqu’en mars.',ar:'حوالي سبعين ألفًا سنويًا. إنه مؤجر حتى مارس.',ph:'eu-BAOUT SÈ-veun-ti þAOU-zeund eu YIEU. its RÈN-tid ann-TIL MÂTCH'},
      ...
      {me:true,choices:['Could you give me a breakdown of all the associated costs?','Could you give me a table by the window?','Could you give me a Nol card?'],fr:'Pourriez-vous me détailler tous les frais associés ?',ar:'هل يمكنك أن تعطيني تفصيلًا لجميع التكاليف المرتبطة؟'},
      {who:'Agent',en:'Service charges, the transfer fee and my commission. I’ll send you everything.',fr:'Les charges, les frais de transfert et ma commission. Je vous envoie tout.',ar:'رسوم الخدمات، ورسوم نقل الملكية، وعمولتي. سأرسل لك كل شيء.',ph:'SEU-vis TCHÂ-djiz, ðeu TRANNS-feu FI annd maï keu-MI-cheun. aïl SÈND you ÈV-ri-þinng'},
      {scene:'3 · L’offre'},
      ...
      {who:'Agent',en:'Make me an offer.',fr:'Faites-moi une offre.',ar:'قدّم لي عرضًا.',ph:'MÉÏK mi ann O-feu'},
