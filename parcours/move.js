...
(window.EXPATIA = window.EXPATIA || {}).move = [
  {id:'move-metro',emoji:'🚇',kind:'mixed',title:'Métro et carte Nol',desc:'Recharger sa carte, trouver sa ligne, savoir où descendre.',
    ...
    words:[
      ['Nol card','Carte Nol (carte de transport)','بطاقة نول','💳','NOL KARD'],
      ['Station','Station','محطة','🚉','STÉÏ-cheun'],
      ['Red Line','Ligne rouge','الخط الأحمر','🔴','RÈD LAÏN'],
      ['Platform','Quai','رصيف','🛤️','PLAT-form'],
      ['Next stop','Prochain arrêt','المحطة التالية','➡️','NÈKST STOP'],
      ['I’d like to top up my Nol card.','Je voudrais recharger ma carte Nol.','أريد شحن بطاقة نول.','🔋','aïd LAÏK tou TOP AP maï NOL KARD'],
      ...
      ['Where do I change?','Où dois-je changer de ligne ?','أين أغيّر الخط؟','🔄','OUÈR dou aï TCHÉÏNDJ'],
    ...
    dialogue:[
      ...
      {who:'Staff',en:'The Red Line. It’s six stops from here.',fr:'La ligne rouge. C’est à six arrêts d’ici.',ar:'الخط الأحمر. على بعد ست محطات من هنا.',ph:'ðeu RÈD LAÏN. its SIKS STOPS from HIR'},
  ...
  {id:'move-petrol',emoji:'⛽',kind:'mixed',title:'À la station-service',desc:'Faire le plein, choisir le carburant, payer.',
    ...
    words:[
      ...
      ['Can you check the tyre pressure?','Pouvez-vous vérifier la pression des pneus ?','هل يمكنك فحص ضغط الإطارات؟','🛞','kann you TCHÈK ðeu TAÏ-eur PRÈ-cheur'],
      ['Car wash','Lavage auto','غسيل السيارات','🧽','KAR OUOCH']
    ],
    dialogue:[
      {scene:'À la pompe'},
      ...
      {me:true,choices:['Yes, can you check the tyre pressure?','Yes, can you lower the rent?','Yes, can you send me some photos?'],fr:'Oui, pouvez-vous vérifier la pression des pneus ?',ar:'نعم، هل يمكنك فحص ضغط الإطارات؟',ph:'YÈS, kann you TCHÈK ðeu TAÏ-eur PRÈ-cheur'},
      ...
      {who:'Attendant',en:'Yes, of course.',fr:'Oui, bien sûr.',ar:'نعم، بالتأكيد.',ph:'YÈS, ov KORS'},
  ...
  {id:'move-garage',emoji:'🔧',kind:'phrases',title:'Au garage',desc:'Décrire une panne, demander un devis et un délai.',
    words:[
      ...
      ['The brakes are not working well.','Les freins ne marchent pas bien.','الفرامل لا تعمل جيدًا.','🛑','ðeu BRÉÏKS ar NOT WEUR-kinng OUÈL'],
      ...
      ['When can I pick up the car?','Quand puis-je récupérer la voiture ?','متى يمكنني استلام السيارة؟','🚗','OUÈN kann aï PIK AP ðeu KAR'],
      ['Is it under warranty?','Est-ce sous garantie ?','هل هي تحت الضمان؟','🛡️','iz it ANN-deur OUO-reun-ti']
    ],
    dialogue:[
      {scene:'Au garage'},
      {who:'Mechanic',en:'Hello, what’s the problem with the car?',fr:'Bonjour, quel est le problème avec la voiture ?',ar:'مرحبًا، ما مشكلة السيارة؟',ph:'hè-LO, OUOTS ðeu PRO-bleum ouið ðeu KAR'},
      ...
      {who:'Mechanic',en:'About six hundred dirhams, with the parts.',fr:'Environ six cents dirhams, avec les pièces.',ar:'حوالي ستمئة درهم، مع قطع الغيار.',ph:'eu-BAOUT SIKS HAN-dreud DIR-hamz, ouið ðeu PARTS'},
      ...
      {who:'Mechanic',en:'Two hours.',fr:'Deux heures.',ar:'ساعتان.',ph:'TOU AOU-eurz'},
      {me:true,choices:['Perfect. I’ll wait here.','Perfect. I’ll take the flat.','Perfect. Welcome to Dubai.'],fr:'Parfait. J’attends ici.',ar:'ممتاز. سأنتظر هنا.',ph:'PEUR-fikt. aïl OUÉÏT HIR'}
    ]},
  {id:'move-mission',emoji:'🎯',kind:'mission',title:'Mission 03 — Fill up your car',desc:'Faire le plein puis passer au garage.',
    ...
    dialogue:[
      ...
      {who:'Attendant',en:'Hello! Petrol or diesel?',fr:'Bonjour ! Essence ou diesel ?',ar:'مرحبًا! بنزين أم ديزل؟',ph:'hè-LO ! PÈ-treul or DI-zeul'},
      ...
      {who:'Attendant',en:'Done. One hundred and forty dirhams.',fr:'C’est fait. Cent quarante dirhams.',ar:'تم. مئة وأربعون درهمًا.',ph:'DANN. OUANN HAN-dreud annd FOR-ti DIR-hamz'},
      {me:true,choices:['Here’s my card. Can you check the tyre pressure too?','Here’s my passport. Can I see the kitchen?','Here’s my address. Where is the gate?'],fr:'Voici ma carte. Pouvez-vous aussi vérifier la pression des pneus ?',ar:'هذه بطاقتي. هل يمكنك أيضًا فحص ضغط الإطارات؟',ph:'HIRZ maï KARD. kann you TCHÈK ðeu TAÏ-eur PRÈ-cheur TOU'},
      {who:'Attendant',en:'Sure. The tyres are fine.',fr:'Bien sûr. Les pneus sont bons.',ar:'بالتأكيد. الإطارات جيدة.',ph:'CHOR. ðeu TAÏ-eurz ar FAÏN'},
      ...
      {who:'Mechanic',en:'Let me check. … It’s a small problem with a sensor.',fr:'Je vais regarder. … C’est un petit problème de capteur.',ar:'دعني أفحص. … إنها مشكلة صغيرة في أحد الحساسات.',ph:'lèt mi TCHÈK. its eu SMOL PRO-bleum ouið eu SÈN-seur'},
      ...
      {who:'Mechanic',en:'One hour. You can wait in our café.',fr:'Une heure. Vous pouvez attendre dans notre café.',ar:'ساعة واحدة. يمكنك الانتظار في المقهى لدينا.',ph:'OUANN AOU-eur. you kann OUÉÏT inn AOU-eur ka-FÉÏ'},
