...
(window.EXPATIA = window.EXPATIA || {}).business = [
  {id:'biz-words',emoji:'🏢',kind:'vocab',title:'Le vocabulaire de l’entreprise',desc:'Licence, free zone, mainland, actionnaires.',
    ...
    words:[
      ...
      ['Shareholder','Actionnaire','مساهم','👥','CHÈ-hol-deu'],
      ...
      ['Corporate bank account','Compte bancaire professionnel','حساب مصرفي للشركة','🏦','KÔ-peu-reut BANNK eu-KAOUNT']
    ],
    dialogue:[
      {scene:'Salon des entrepreneurs'},
      {who:'Consultant',en:'Hello! Are you thinking of starting a business in Dubai?',fr:'Bonjour ! Vous pensez créer une entreprise à Dubaï ?',ar:'مرحبًا! هل تفكر في تأسيس شركة في دبي؟',ph:'hè-LO ! â you þINN-kinng ov STÂ-tinng eu BIZ-nis inn dou-BAÏ'},
      ...
      {who:'Consultant',en:'Free zone or mainland?',fr:'Zone franche ou mainland ?',ar:'منطقة حرة أم البر الرئيسي؟',ph:'FRI ZONN ô MÉÏN-leund'},
      ...
      {who:'Consultant',en:'With a mainland licence, you can work with clients everywhere in the UAE.',fr:'Avec une licence mainland, vous pouvez travailler avec des clients partout aux Émirats.',ar:'برخصة البر الرئيسي، يمكنك العمل مع العملاء في كل أنحاء الإمارات.',ph:'ouið eu MÉÏN-leund LAÏ-seuns, you kann WEUK ouið KLAÏ-eunts ÈV-ri-ouèr inn ði you-éï-I'},
  ...
  {id:'biz-consultant',emoji:'🧑‍💼',kind:'phrases',title:'Parler avec un consultant',desc:'Étapes, coûts détaillés, frais cachés, délais.',
    words:[
      ...
      ['What are the steps?','Quelles sont les étapes ?','ما هي الخطوات؟','🪜','OUOT â ðeu STÈPS'],
      ['What are the total costs?','Quels sont les coûts totaux ?','ما هي التكاليف الإجمالية؟','🧮','OUOT â ðeu TO-teul KOSTS'],
      ...
      ['Are there any hidden fees?','Y a-t-il des frais cachés ?','هل توجد رسوم خفية؟','🕵️','â ðèr È-ni HI-deun FIZ'],
      ...
      ['Can I have a business partner?','Puis-je avoir un associé ?','هل يمكنني أن يكون لي شريك؟','🤝','kann aï HAV eu BIZ-nis PÂT-neu'],
      ['Do I need a local sponsor?','Ai-je besoin d’un sponsor local ?','هل أحتاج إلى كفيل محلي؟','❔','dou aï NID eu LO-keul SPONN-seu']
    ],
    dialogue:[
      {scene:'Rendez-vous avec le consultant'},
      {who:'Consultant',en:'So, what kind of business do you want to start?',fr:'Alors, quel type d’entreprise voulez-vous créer ?',ar:'إذن، ما نوع النشاط الذي تريد تأسيسه؟',ph:'SO, OUOT KAÏND ov BIZ-nis dou you OUONT tou STÂT'},
      {me:true,choices:['A consulting company. What are the steps?','A consulting company. What are the tyres like?','A consulting company. What time is breakfast?'],fr:'Une société de conseil. Quelles sont les étapes ?',ar:'شركة استشارات. ما هي الخطوات؟',ph:'eu keun-SAL-tinng KAMM-peu-ni. OUOT â ðeu STÈPS'},
      {who:'Consultant',en:'First the trade name, then the licence, then the visas.',fr:'D’abord le nom commercial, puis la licence, puis les visas.',ar:'أولًا الاسم التجاري، ثم الرخصة، ثم التأشيرات.',ph:'FEUST ðeu TRÉÏD NÉÏM, ðèn ðeu LAÏ-seuns, ðèn ðeu VI-zaz'},
      ...
      {who:'Consultant',en:'No, but you must renew the licence every year.',fr:'Non, mais vous devez renouveler la licence chaque année.',ar:'لا، لكن يجب تجديد الرخصة كل سنة.',ph:'NO, bat you MAST ri-NIOU ðeu LAÏ-seuns ÈV-ri YIEU'},
  ...
  {id:'biz-space',emoji:'🏬',kind:'phrases',title:'Louer un local commercial',desc:'Surface, loyer au pied carré, charges, bail.',
    ...
    words:[
      ['I’m looking for a commercial property.','Je cherche un local commercial.','أبحث عن عقار تجاري.','🏬','aïm LOU-kinng for eu keu-MEU-cheul PRO-peu-ti'],
      ['What is the size in square feet?','Quelle est la surface en pieds carrés ?','ما المساحة بالقدم المربع؟','📐','OUOT iz ðeu SAÏZ inn SKOUÈ FIT'],
      ['What is the rent per square foot?','Quel est le loyer au pied carré ?','ما الإيجار لكل قدم مربع؟','💲','OUOT iz ðeu RÈNT peu SKOUÈ FOUT'],
      ['What are the service charges?','Quelles sont les charges de service ?','ما هي رسوم الخدمات؟','🧾','OUOT â ðeu SEU-vis TCHÂ-djiz'],
      ['How long is the lease?','Quelle est la durée du bail ?','ما مدة عقد الإيجار؟','📜','haou LONNG iz ðeu LIS'],
      ['Can we have a rent-free period for the fit-out?','Pouvons-nous avoir une période sans loyer pour l’aménagement ?','هل يمكن الحصول على فترة بدون إيجار لأعمال التجهيز؟','🛠️','kann oui HAV eu RÈNT-FRI PI-ri-eud fô ðeu FIT-aout'],
      ['Is parking included?','Le parking est-il inclus ?','هل الموقف مشمول؟','🅿️','iz PÂ-kinng inn-KLOU-did'],
    ...
    dialogue:[
      ...
      {who:'Agent',en:'This office is on the fifteenth floor, with a view of the Burj Khalifa.',fr:'Ce bureau est au quinzième étage, avec vue sur la Burj Khalifa.',ar:'هذا المكتب في الطابق الخامس عشر، مع إطلالة على برج خليفة.',ph:'ðis O-fis iz onn ðeu fif-TINþ FLÔ, ouið eu VIOU ov ðeu BEURDJ ka-LI-fa'},
      {me:true,choices:['Very nice. What is the size in square feet?','Very nice. What is your emergency?','Very nice. What do you recommend for dessert?'],fr:'Très joli. Quelle est la surface en pieds carrés ?',ar:'جميل جدًا. ما المساحة بالقدم المربع؟',ph:'VÈ-ri NAÏS. OUOT iz ðeu SAÏZ inn SKOUÈ FIT'},
      {who:'Agent',en:'One thousand two hundred square feet.',fr:'Mille deux cents pieds carrés.',ar:'ألف ومئتا قدم مربع.',ph:'OUANN þAOU-zeund TOU HAN-dreud SKOUÈ FIT'},
      ...
      {who:'Agent',en:'One hundred and ten dirhams per square foot per year.',fr:'Cent dix dirhams le pied carré par an.',ar:'مئة وعشرة دراهم للقدم المربع سنويًا.',ph:'OUANN HAN-dreud annd TÈN DIR-hamz peu SKOUÈ FOUT peu YIEU'},
      ...
      {who:'Agent',en:'Fifteen dirhams per square foot.',fr:'Quinze dirhams le pied carré.',ar:'خمسة عشر درهمًا للقدم المربع.',ph:'fif-TIN DIR-hamz peu SKOUÈ FOUT'},
      ...
      {who:'Agent',en:'I think the landlord can offer two months.',fr:'Je pense que le propriétaire peut accorder deux mois.',ar:'أعتقد أن المالك يمكنه منح شهرين.',ph:'aï þINNK ðeu LANND-lôd kann O-feu TOU MANþS'}
    ]},
  {id:'biz-mission',emoji:'🎯',kind:'mission',title:'Mission 07 — Rent a commercial space',desc:'Trouver et négocier le bureau de votre société.',
    ...
    dialogue:[
      ...
      {me:true,choices:['It’s nice. What is the size in square feet?','It’s nice. What is the salary range?','It’s nice. What is the next stop?'],fr:'Il est bien. Quelle est la surface en pieds carrés ?',ar:'إنه جيد. ما المساحة بالقدم المربع؟',ph:'its NAÏS. OUOT iz ðeu SAÏZ inn SKOUÈ FIT'},
      {who:'Agent',en:'Nine hundred square feet, at one hundred dirhams per square foot.',fr:'Neuf cents pieds carrés, à cent dirhams le pied carré.',ar:'تسعمئة قدم مربع، بمئة درهم للقدم المربع.',ph:'NAÏN HAN-dreud SKOUÈ FIT, at OUANN HAN-dreud DIR-hamz peu SKOUÈ FOUT'},
      {me:true,choices:['And what are the service charges?','And what are your strengths?','And what are the symptoms?'],fr:'Et quelles sont les charges de service ?',ar:'وما هي رسوم الخدمات؟',ph:'annd OUOT â ðeu SEU-vis TCHÂ-djiz'},
      {who:'Agent',en:'Twelve dirhams per square foot.',fr:'Douze dirhams le pied carré.',ar:'اثنا عشر درهمًا للقدم المربع.',ph:'TOUÈLV DIR-hamz peu SKOUÈ FOUT'},
      {scene:'3 · La négociation'},
      {who:'Agent',en:'So, are you interested?',fr:'Alors, ça vous intéresse ?',ar:'إذن، هل أنت مهتم؟',ph:'SO, â you INN-treus-tid'},
      {me:true,choices:['Yes, if we can have a rent-free period for the fit-out.','Yes, if we can have the grilled chicken.','Yes, if we can have a Nol card.'],fr:'Oui, si nous pouvons avoir une période sans loyer pour l’aménagement.',ar:'نعم، إذا حصلنا على فترة بدون إيجار لأعمال التجهيز.',ph:'YÈS, if oui kann HAV eu RÈNT-FRI PI-ri-eud fô ðeu FIT-aout'},
      {who:'Agent',en:'The landlord can offer one month.',fr:'Le propriétaire peut accorder un mois.',ar:'يمكن للمالك منح شهر واحد.',ph:'ðeu LANND-lôd kann O-feu OUANN MANþ'},
      {me:true,choices:['Could it be two months if we sign for three years?','Could it be two dirhams if we fill it up?','Could it be two bedrooms with a sea view?'],fr:'Serait-il possible d’avoir deux mois si nous signons pour trois ans ?',ar:'هل يمكن أن تكون شهرين إذا وقّعنا لثلاث سنوات؟',ph:'koud it bi TOU MANþS if oui SAÏN fô þRI YIEUZ'},
      {who:'Agent',en:'I’ll ask him. I think it’s possible.',fr:'Je vais lui demander. Je pense que c’est possible.',ar:'سأسأله. أعتقد أن ذلك ممكن.',ph:'aïl ÂSK him. aï þINNK its PO-si-beul'},
      {me:true,choices:['Great. Can we renew the lease after three years?','Great. Can we see the kitchen after three years?','Great. Can we call an ambulance?'],fr:'Parfait. Pourrons-nous renouveler le bail après trois ans ?',ar:'رائع. هل يمكننا تجديد عقد الإيجار بعد ثلاث سنوات؟',ph:'GRÉÏT. kann oui ri-NIOU ðeu LIS ÂF-teu þRI YIEUZ'},
