...
(window.EXPATIA = window.EXPATIA || {}).work = [
  {id:'work-search',emoji:'🔎',kind:'mixed',title:'Chercher un emploi',desc:'Offre, CV, candidature, appeler l’entreprise.',
    words:[
      ['Job offer','Offre d’emploi','عرض عمل','📢','DJOB O-feu'],
      ['CV','CV','سيرة ذاتية','📄','si-VI'],
      ['Cover letter','Lettre de motivation','رسالة تحفيزية','✉️','KA-veu LÈ-teu'],
      ['Salary','Salaire','راتب','💰','SA-leu-ri'],
      ['Full-time','Temps plein','دوام كامل','🕘','FOUL-TAÏM'],
      ['I’m applying for the sales manager position.','Je postule pour le poste de responsable commercial.','أتقدم لوظيفة مدير المبيعات.','🙋','aïm eu-PLAÏ-inng fô ðeu SÉÏLZ MA-ni-djeu peu-ZI-cheun'],
      ...
      ['I look forward to hearing from you.','Dans l’attente de votre réponse.','أتطلع إلى ردكم.','🤝','aï LOUK FÔ-oueud tou HI-rinng from you']
    ],
    dialogue:[
      {scene:'Appel à une entreprise'},
      {who:'HR',en:'Good morning, Al Noor Trading, human resources.',fr:'Bonjour, Al Noor Trading, ressources humaines.',ar:'صباح الخير، النور للتجارة، قسم الموارد البشرية.',ph:'goud MÔ-ninng, al NOUR TRÉÏ-dinng, HIOU-meun ri-ZÔ-siz'},
      {me:true,choices:['Hello, I’m calling about the sales manager job offer.','Hello, I’m calling about my luggage.','Hello, I’m calling about the grilled chicken.'],fr:'Bonjour, j’appelle au sujet de l’offre de responsable commercial.',ar:'مرحبًا، أتصل بخصوص عرض وظيفة مدير المبيعات.',ph:'hè-LO, aïm KO-linng eu-BAOUT ðeu SÉÏLZ MA-ni-djeu DJOB O-feu'},
      ...
      {who:'HR',en:'Yes. Please send your CV and a cover letter by email.',fr:'Oui. Envoyez votre CV et une lettre de motivation par email.',ar:'نعم. أرسل سيرتك الذاتية ورسالة تحفيزية بالبريد الإلكتروني.',ph:'YÈS. PLIZ SÈND yô si-VI annd eu KA-veu LÈ-teu baï I-méïl'},
      {me:true,choices:['Of course. Is it full-time?','Of course. Is it furnished?','Of course. Is it direct?'],fr:'Bien sûr. Est-ce à temps plein ?',ar:'بالتأكيد. هل هي بدوام كامل؟',ph:'ov KÔS. iz it FOUL-TAÏM'},
  ...
  {id:'work-interview',emoji:'💼',kind:'phrases',title:'L’entretien d’embauche',desc:'Vous présenter, parler de votre expérience, poser vos questions.',
    ...
    words:[
      ['Tell me about yourself.','Parlez-moi de vous.','حدثني عن نفسك.','🗣️','TÈL mi eu-BAOUT yô-SÈLF'],
      ['I have ten years of experience in sales.','J’ai dix ans d’expérience dans la vente.','لدي عشر سنوات من الخبرة في المبيعات.','📈','aï HAV TÈN YIEUZ ov iks-PI-ri-euns inn SÉÏLZ'],
      ['My strengths are organisation and teamwork.','Mes points forts sont l’organisation et le travail en équipe.','نقاط قوتي هي التنظيم والعمل الجماعي.','💪','maï STRÈNGþS ar ô-geu-naï-ZÉÏ-cheun annd TIM-weuk'],
      ...
      ['What are the working hours?','Quels sont les horaires de travail ?','ما هي ساعات العمل؟','🕘','OUOT â ðeu WEU-kinng AOU-euz'],
      ...
      ['When can I expect an answer?','Quand puis-je espérer une réponse ?','متى يمكنني أن أتوقع ردًا؟','⏳','OUÈN kann aï iks-PÈKT ann ÂNN-seu']
    ],
    dialogue:[
      {scene:'L’entretien'},
      {who:'Manager',en:'Thank you for coming. Tell me about yourself.',fr:'Merci d’être venu. Parlez-moi de vous.',ar:'شكرًا على حضورك. حدثني عن نفسك.',ph:'þANK you fô KA-minng. TÈL mi eu-BAOUT yô-SÈLF'},
      ...
      {who:'Manager',en:'Interesting. What are your strengths?',fr:'Intéressant. Quels sont vos points forts ?',ar:'مثير للاهتمام. ما هي نقاط قوتك؟',ph:'INN-treus-tinng. OUOT â yô STRÈNGþS'},
      ...
      {who:'Manager',en:'Do you speak other languages?',fr:'Parlez-vous d’autres langues ?',ar:'هل تتحدث لغات أخرى؟',ph:'dou you SPIK A-ðeu LANN-gouidj-iz'},
      ...
      {me:true,choices:['That sounds good. When can I expect an answer?','That sounds good. When is check-out?','That sounds good. When is the next stop?'],fr:'Ça me convient. Quand puis-je espérer une réponse ?',ar:'هذا جيد. متى يمكنني أن أتوقع ردًا؟',ph:'ðat SAOUNDZ GOUD. OUÈN kann aï iks-PÈKT ann ÂNN-seu'},
  ...
  {id:'work-office',emoji:'🖥️',kind:'phrases',title:'Au bureau',desc:'Premier jour, réunions, emails, délais.',
    words:[
      ['Nice to meet you, I’m the new sales manager.','Enchanté(e), je suis le nouveau responsable commercial.','تشرفت بمعرفتك، أنا مدير المبيعات الجديد.','👋','NAÏS tou MIT you, aïm ðeu NIOU SÉÏLZ MA-ni-djeu'],
      ...
      ['Could you repeat that more slowly?','Pourriez-vous répéter plus lentement ?','هل يمكنك تكرار ذلك ببطء أكثر؟','🐢','koud you ri-PIT ðat MÔ SLO-li'],
      ['I’m working from home today.','Je télétravaille aujourd’hui.','أعمل من المنزل اليوم.','🏠','aïm WEU-kinng from HOM teu-DÉÏ'],
      ['I’ll be late for the meeting.','Je serai en retard à la réunion.','سأتأخر عن الاجتماع.','🏃','aïl bi LÉÏT fô ðeu MI-tinng']
    ],
    dialogue:[
      {scene:'Premier jour'},
      {who:'Colleague',en:'Hi! You must be the new sales manager.',fr:'Salut ! Vous devez être le nouveau responsable commercial.',ar:'مرحبًا! لا بد أنك مدير المبيعات الجديد.',ph:'HAÏ ! you MAST bi ðeu NIOU SÉÏLZ MA-ni-djeu'},
      ...
      {who:'Colleague',en:'I’m Priya, from the marketing team. Welcome!',fr:'Je suis Priya, de l’équipe marketing. Bienvenue !',ar:'أنا بريا، من فريق التسويق. أهلًا بك!',ph:'aïm PRI-ya, from ðeu MÂ-ki-tinng TIM. OUÈL-keum'},
      ...
      {who:'Colleague',en:'At ten, in room B. We’ll discuss the quarterly targets.',fr:'À dix heures, en salle B. Nous parlerons des objectifs trimestriels.',ar:'في العاشرة، في القاعة B. سنناقش الأهداف الفصلية.',ph:'at TÈN, inn ROUM BI. ouil dis-KAS ðeu KOUÔ-teu-li TÂ-guits'},
      ...
      {who:'Colleague',en:'Sure. The meeting is at ten o’clock, in room B.',fr:'Bien sûr. La réunion est à dix heures, en salle B.',ar:'بالتأكيد. الاجتماع في الساعة العاشرة، في القاعة B.',ph:'CHÔ. ðeu MI-tinng iz at TÈN eu-KLOK, inn ROUM BI'},
      {me:true,choices:['Thank you. What is the deadline for the report?','Thank you. What is the exchange rate for the report?','Thank you. What is your apartment number?'],fr:'Merci. Quelle est la date limite pour le rapport ?',ar:'شكرًا. ما هو الموعد النهائي للتقرير؟',ph:'þANK you. OUOT iz ðeu DÈD-laïn fô ðeu ri-PÔT'},
      {who:'Colleague',en:'Thursday. I’ll send you an email with the details.',fr:'Jeudi. Je vous envoie un email avec les détails.',ar:'الخميس. سأرسل لك بريدًا إلكترونيًا بالتفاصيل.',ph:'þEUZ-déï. aïl SÈND you ann I-méïl ouið ðeu DI-téïlz'}
    ]},
  {id:'work-mission',emoji:'🎯',kind:'mission',title:'Mission 06 — Get the job',desc:'Réussir votre entretien d’embauche.',
    ...
    dialogue:[
      {scene:'1 · À l’accueil'},
      {who:'Receptionist',en:'Good morning. Can I help you?',fr:'Bonjour. Je peux vous aider ?',ar:'صباح الخير. هل يمكنني مساعدتك؟',ph:'goud MÔ-ninng. kann aï HÈLP you'},
      {me:true,choices:['Yes, I have an interview with Mr Ahmed at ten.','Yes, I have a fever and a headache.','Yes, I have a table for two.'],fr:'Oui, j’ai un entretien avec M. Ahmed à dix heures.',ar:'نعم، لدي مقابلة مع السيد أحمد في الساعة العاشرة.',ph:'YÈS, aï HAV ann INN-teu-viou ouið MIS-teur a-MÈD at TÈN'},
      {who:'Receptionist',en:'Please take a seat. He’ll be with you shortly.',fr:'Asseyez-vous, il arrive tout de suite.',ar:'تفضل بالجلوس. سيكون معك بعد قليل.',ph:'PLIZ TÉÏK eu SIT. hil bi ouið you CHÔT-li'},
      ...
      {me:true,choices:['I’m Karim. I have ten years of experience in sales.','I’m Karim. I have a work visa for two weeks.','I’m Karim. I have a water leak.'],fr:'Je suis Karim. J’ai dix ans d’expérience dans la vente.',ar:'أنا كريم. لدي عشر سنوات من الخبرة في المبيعات.',ph:'aïm ka-RIM. aï HAV TÈN YIEUZ ov iks-PI-ri-euns inn SÉÏLZ'},
      {who:'Manager',en:'Why do you want to work in Dubai?',fr:'Pourquoi voulez-vous travailler à Dubaï ?',ar:'لماذا تريد العمل في دبي؟',ph:'OUAÏ dou you OUONT tou WEUK inn dou-BAÏ'},
      {me:true,choices:['Because it’s an international city with many opportunities.','Because it’s on the twelfth floor.','Because it’s buy one, get one free.'],fr:'Parce que c’est une ville internationale avec beaucoup d’opportunités.',ar:'لأنها مدينة دولية فيها الكثير من الفرص.',ph:'bi-KOZ its ann inn-teu-NA-cheu-neul SI-ti ouið MÈ-ni o-peu-TIOU-ni-tiz'},
      {who:'Manager',en:'Do you speak other languages?',fr:'Parlez-vous d’autres langues ?',ar:'هل تتحدث لغات أخرى؟'},
      {me:true,choices:['I speak French, Arabic and English.','I speak with the landlord.','I speak by card.'],fr:'Je parle français, arabe et anglais.',ar:'أتحدث الفرنسية والعربية والإنجليزية.'},
      {who:'Manager',en:'Great. Any questions for me?',fr:'Parfait. Avez-vous des questions ?',ar:'رائع. هل لديك أسئلة لي؟',ph:'GRÉÏT. È-ni KOUÈS-tcheunz fô MI'},
      {me:true,choices:['Yes. What are the working hours?','Yes. What are the tyres like?','Yes. What are your allergies?'],fr:'Oui. Quels sont les horaires de travail ?',ar:'نعم. ما هي ساعات العمل؟',ph:'YÈS. OUOT â ðeu WEU-kinng AOU-euz'},
